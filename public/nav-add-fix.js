  ...
  async function openCameraScanner(){
    ...
    try{
      await new Promise((resolve,reject)=>{
        ...
        const s=document.createElement('script');s.dataset.bdScannerLoader='1';s.src='/ean-scanner.js?v=20260905-7';s.onload=resolve;s.onerror=reject;document.head.appendChild(s);
      });
