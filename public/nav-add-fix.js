(()=>{
  window.__BD_ADD_FLOW_VERSION='2026-09-07.1';
  ...
  async function openCameraScanner(){
    ...
    try{
      await new Promise((resolve,reject)=>{
        ...
        const s=document.createElement('script');s.dataset.bdScannerLoader='1';s.src='/ean-scanner.js?v=20260907-3';s.onload=resolve;s.onerror=reject;document.head.appendChild(s);
      });
