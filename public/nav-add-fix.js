(()=>{
  window.__BD_ADD_FLOW_VERSION='2026-09-06.6';
  ...
  async function openCameraScanner(){
    ...
    try{
      await new Promise((resolve,reject)=>{
        ...
        const s=document.createElement('script');s.dataset.bdScannerLoader='1';s.src='/ean-scanner.js?v=20260905-6';s.onload=resolve;s.onerror=reject;document.head.appendChild(s);
      });
