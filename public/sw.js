const CACHE='bd-desk-v9'; const CORE=['/','/styles.css','/mobile-fixes.css','/route-scroll.js','/cover-fallback.js','/detail-enhance.js','/nav-add-fix.js','/ean-scanner.js','/app.js','/manifest.webmanifest'];
