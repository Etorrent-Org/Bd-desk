const CACHE='bd-desk-v11'; const CORE=['/','/styles.css','/mobile-fixes.css','/route-scroll.js','/cover-fallback.js','/detail-enhance.js','/nav-add-fix.js','/ean-scanner.js?v=20260901-4','/app.js','/manifest.webmanifest'];
