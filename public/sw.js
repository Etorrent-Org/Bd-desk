const CACHE='bd-desk-v7'; const CORE=['/','/styles.css','/mobile-fixes.css','/route-scroll.js','/cover-fallback.js','/detail-enhance.js','/nav-add-fix.js','/app.js','/manifest.webmanifest'];
