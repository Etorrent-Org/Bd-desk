...
| QA-IOS-002 — iPhone / navigateur réel / chargement initial en portrait : page d'accueil complète, sans écran blanc, erreur ni débordement horizontal | ⏳ **PROCHAIN TEST** | À venir |
