...
| QA-IOS-002 — iPhone / navigateur réel / chargement initial en portrait : page d'accueil complète, sans écran blanc, erreur ni débordement horizontal | ⚠️ **Capture reçue sur iPhone dans Brave, mais en paysage**. Le responsive compact s'active correctement : sidebar remplacée par menu hamburger, header et recherche restent accessibles, actions Exporter/Importer et filtres sont visibles, grille de collection et FAB s'affichent sans chevauchement visible. **Le portrait reste à contrôler pour clôturer QA-IOS-002.** | Direct `main` — preuve matérielle, aucun correctif requis à ce stade |
| QA-IOS-003 — iPad / navigation principale en portrait : navigation, sidebar/menu, FAB et zones tactiles | ⏳ À valider après QA-IOS-002 | À venir |
